...
class TrainConfig:
    ...
    save_dir: str = "ckpt/disp2struct_crf.v1.2_cp"
    fig_dir: str = "tfig_inv_v1.2_cp"
    resume: bool = True
    ...
    torch.save(
        {
            ...
            "config": asdict(cfg),
            "model_name": "Disp2StructControlPointCRFV12",
...
def train_disp2struct_crf(
    ...
    print("========== Disp2Struct Control-Point CRF v1.2 Training Start ==========")
    ...
    write_log_line(
        log_path,
        (
            f"========== Disp2Struct Control-Point CRF v1.2 Training Start | start_epoch={start_epoch} "
    ...
    print("========== Disp2Struct Control-Point CRF v1.2 Training Done ==========")
